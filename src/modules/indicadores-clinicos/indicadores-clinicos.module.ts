...
import { IndicadoresClinicosController, CategoriasIndicadoresController } from './controllers/index';
...
@Module({
  imports: [TypeOrmModule.forFeature([CategoriaIndicador, IndicadorClinico, DiagnosticoIndicadorClinico, Diagnostico])],
  controllers: [IndicadoresClinicosController, CategoriasIndicadoresController],
  providers: [service.IndicadoresClinicosService, service.CategoriasIndicadoresService],
  exports: [service.IndicadoresClinicosService, service.CategoriasIndicadoresService],
})
